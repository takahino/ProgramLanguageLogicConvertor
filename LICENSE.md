...
This software is dual-licensed. Choose the license that applies to your use case.

---

## Option 1: GNU General Public License v3.0 (GPLv3)

For individuals and non-commercial use only.
Commercial use by corporations or legal entities requires a separate
commercial license (THCL). See Option 2 below.

Copyright (c) 2026 T. Hino
...
## Option 2: T. Hino Commercial License (THCL) v1.0

For commercial use and use by corporations or legal entities.
...
1. Grant of License
   Any person or entity wishing to use the Software for commercial purposes,
   or any corporation or legal entity wishing to use the Software, must
   submit a usage application to the Author and obtain written or electronic
   approval before a license is granted.
   Any commercial or corporate use without such approval shall be deemed
...
5. Restriction on Modification
   Any modification of the Software for commercial purposes requires
   separate written or electronic approval from the Author.
   Commercial use of modified versions without such approval shall
   constitute a violation of this license.
...
|----------|--------------------|
| Personal use, study, research (non-commercial) | GPLv3 |
| Incorporation into OSS projects | GPLv3 |
| Use by corporations or legal entities | THCL (application required) |
| Internal business or commercial product use | THCL (application required) |
| Commercial use with modification | THCL (application + approval required) |
| Academic publications (no citation obligation) | GPLv3 |
| Academic publications (with citation obligation) | THCL (application required) |
